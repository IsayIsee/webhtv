...
| 37 | `P8-MPV-CONFIG-SYNC` | MPV App/通用 | 一键同步 MPV 配置管理的三个目标及 profile 状态 | **实施中（用户已批准）**：独立 `mpvConfigFiles` allowlist archive，携带 `mpv.conf`、`input.conf`、`scripts/` 与受管 profile 快照/元数据 | [P8-mpv-config-sync.md](P8-mpv-config-sync.md) |
